...
/*   Updated: 2025/02/04 15:10:45 by obellil-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	 mov_a_to_b(t_stack_node **stack_a, t_stack_node **stack_b)
{
	...
	if(cheapest_n-> above_median && cheapest_n ->target_node->above_median)
		...
		rrr(stack_a,stack_b,cheapest_n);
...
static void	min_ontop(t_stack_node **stack_a)
{
...
void init_n_a(t_stack_node *stack_a, t_stack_node *stack_b);
void move_a_to_b(t_stack_node **stack_a, t_stack_node **stack_b);
void init_n_b(t_stack_node *stack_a, t_stack_node *stack_b);
